...
docker image build -t doublesharp/mariadb-alpine:10.1 --build-arg MARIADB_VERSION===10.1.41-r0 --build-arg APK_REPO=v3.7 --build-arg ALPINE_TAG=3.7 --build-arg SKIP_SERVER_UTILS=true .
